  ...
  return (
    <div className={`p-10 flex justify-center m-15 ${backgroundColor}`}>
      <div className="rounded border-dashed border-4 border-green-300 p-10 mb-5 w-full">
        <h1 className={`text-3xl text-center mb-10 font-serif font-bold ${textColor}`} style={{ textShadow: '0px 2px 4px #98FFD9' }}>No hemos encontrado resultados para tu pregunta</h1>
